...
#if defined(NDEBUG)
# error "Tongxingpoints cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Tongxingpoints Signed Message:\n";
...
//    cout <<  "g_signals.SyncTransaction(hash, pBaseTx, NULL);" << " main.cpp"<< endl;
