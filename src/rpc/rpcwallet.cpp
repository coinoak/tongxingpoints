...
//	obj.push_back(Pair("public key", newKey.ToString()));
	return obj;
}
...
Value signmessage(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 2)
        throw runtime_error(
            ...
            "\nArguments:\n"
            "1. \"Dacrsaddress\"  (string, required) The Tongxingpoints address to use for the private key.\n"
...
Value sendtoaddresswithfee(const Array& params, bool fHelp)
 {
	...
	if (fHelp || (!(size == 3 || size == 4)))
		throw runtime_error(
						...
						"\nArguments:\n"
						"1. \"sendaddress\"  (string, optional) The Tongxingpoints address to send to.\n"
						"2. \"recvaddress\" (string, required) The Tongxingpoints address to receive.\n"
...
Value sendtoaddressraw(const Array& params, bool fHelp)
{
	...
	if (fHelp || size < 4 || size > 5 )
		throw runtime_error(
						...
						"3. \"srcaddress\"  (string, required) The Tongxingpoints address to send to.\n"
						"4. \"recvaddress\"  (string, required) The Tongxingpoints address to receive.\n"
...
Value sendtoaddress(const Array& params, bool fHelp)
 {
	...
	if (fHelp || (!(size == 2 || size == 3)))
		throw runtime_error(
						...
						+ HelpRequiringPassphrase() + "\nArguments:\n"
						"1. \"Dacrsaddress\"  (string, optional) The Tongxingpoints address to send to.\n"
						"2. receive address   (string, required) The Tongxingpoints address to receive\n"
						"3.\"amount\"   (string, required) \n"
						"\nResult:\n"
						"\"transactionid\"  (string) The transaction id.\n"
						"\nExamples:\n"
...
Value encryptwallet(const Array& params, bool fHelp)
{
    if (!pwalletMain->IsCrypted() && (fHelp || params.size() != 1))
        throw runtime_error(
            ...
            "\nNow set the passphrase to use the wallet, such as for signing or sending Tongxingpoints\n"
...
//    boost::filesystem::rename(GetDataDir() / strFileCopy, GetDataDir() / defaultFilename);
    ...
    return retObj;
    //return "wallet encrypted; Tongxingpoints server stopping, restart to run with encrypted wallet. The keypool has been flushed, you need to make a new backup.";
}
...
Value getwalletinfo(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total Tongxingpoints balance of the wallet\n"
