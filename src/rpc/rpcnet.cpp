...
Value getaddednodeinfo(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "    \"addresses\" : [\n"
            "       {\n"
            "         \"address\" : \"192.168.0.201:8333\",  (string) The Tongxingpoints server host and port\n"
...
/*
 *   获取最近 N个块状态信息: gettongxingpointsstate  param
 *
 * */
Value gettongxingpointsstate(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "gettongxingpointsstate \"num\"\n"
            ...
            "}\n"
            "\nExamples:\n"
            + HelpExampleCli("gettongxingpointsstate", "\"5\"")
            + HelpExampleRpc("gettongxingpointsstate", "\"5\"")
       );
