...
#ifndef _TONGXINGPOINTSRPC_PROTOCOL_H_
#define _TONGXINGPOINTSRPC_PROTOCOL_H_ 1
...
// Tongxingpoints RPC error codes
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // Tongxingpoints is not connected
