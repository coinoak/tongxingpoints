...
#ifndef _TONGXINGPOINTSRPC_SERVER_H_
#define _TONGXINGPOINTSRPC_SERVER_H_ 1
...
/**
 * TONGXINGPOINTS RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern json_spirit::Value gettongxingpointsstate(const json_spirit::Array& params, bool fHelp);
