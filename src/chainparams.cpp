...
vector<string> intPubKey_mainNet = {
		"03ffcb5ba25335a4e653270429a272a0db60858d0dfae5d82ffa5c3f8afd664f1e", //init0
		"0285dade9b98af5874408a927ad8b447692e2fe9933e2a6535af4b7a251175a260" //init1
...
// a large 4-byte int at any alignment.
		...
		vAlertPubKey =	ParseHex("03ceaac7b635ee31865513d2fefad68108028ee333e45075e88ba9bf418847aa92");
		nDefaultPort = 23214;
		nRPCPort = 23215;
		strDataDir = "main";
		...
		publicKey = "03ceaac7b635ee31865513d2fefad68108028ee333e45075e88ba9bf418847aa92";
//		{
//			cout << "main hashGenesisBlock:\r\n" << hashGenesisBlock.ToString() << endl;
//			cout << "main hashMerkleRoot:\r\n" << genesis.GetHashMerkleRoot().ToString() << endl;
//		}
		assert(hashGenesisBlock == uint256S("0x73adce9cea101e4c916b1cf876a4f0fa6808b7ae0ec4adb693f78c37d9b01d1f"));
        assert(genesis.GetHashMerkleRoot() == uint256S("0x491ae8186082bde02193db3dc2d721c39457f72a03c52917b16ff8e090d26a95"));
//      vSeeds.push_back(CDNSSeedData("soypay.org.us", "seed_us_0.dspay.org"));
		vSeeds.push_back(CDNSSeedData("120.27.105.172", "120.27.105.172"));
        vSeeds.push_back(CDNSSeedData("115.28.142.221", "115.28.142.221"));
        vSeeds.push_back(CDNSSeedData("115.29.44.249", "115.29.44.249"));


        base58Prefixes[PUBKEY_ADDRESS] = {0x41};
...
public:
	CRegTestParams() {
		...
		assert(genesis.GetHashMerkleRoot() == uint256S("0x89299bb7fb18674f2cbd75557f08c0cb80b70faa110abdd5f35bb87a775e29d2"));
