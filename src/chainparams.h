...
#ifndef TONGXINGPOINTS_CHAIN_PARAMS_H
#define TONGXINGPOINTS_CHAIN_PARAMS_H
#include <memory>
#include "bignum.h"
#include "uint256.h"
 ...
 * Tongxingpoints system. There are three: the main network on which people trade goods
...
protected:
	...
	int64_t nTargetTimespan; //ʵ�ʼ���Ķ��ٸ���ʱ��
...
public:
	...
	virtual bool InitalConfig() {
	   ...
	   nIntervalPos = GetArg("-intervalpos", 150);
	...
	virtual string GetDefaultTestDataPath() const
	{
		...
		#ifdef WIN32
		strCurDir += "\\tongxingpoints_test\\data\\";
		return strCurDir;
		#else
		strCurDir +="/tongxingpoints_test/data/";
		return strCurDir;
		#endif
	}
public:
