...
//static const CTongxingpointsAddress addr1C("1NoJrossxPBKfCHuJXT4HadJrXRE9Fxiqs");
//static const CTongxingpointsAddress addr2C("1CRj2HyM1CXWzHAXLQtiGLyggNT9WQqsDs");
...
//static const CTongxingpointsAddress addr1C("n4PwAoA9zQ3SrndjB4wp8QWb9xPpNdtLsW");
//static const CTongxingpointsAddress addr2C("mfu2Z1UfUBkWQACSXVDr25h5UVU7LmC3xB");
...
void dumpKeyInfo(uint256 privkey)
{
    ...
    for (int nCompressed=0; nCompressed<2; nCompressed++)
    {
        ...
        printf("    * address (base58): %s\n", CTongxingpointsAddress(vchPubKey).ToString().c_str());
    }
}
#endif
...
BOOST_AUTO_TEST_CASE(key_test1)
{
    ...
    CTongxingpointsSecret bsecret1, bsecret2, bsecret1C, bsecret2C, baddress1;
...
//    BOOST_CHECK(addr2C.Get() == CTxDestination(pubkey2C.GetID()));
	if (fRegTest || fTestNet) {
		CTongxingpointsAddress addr1Ct("dgZjR2S98gmdvXDzwKASxKiaGr9Dw1GD8F");
		CTongxingpointsAddress addr2Ct("dw3Ard8fFMvt7nRppEr9cDAoRCCvNxj6vE");

		BOOST_CHECK(addr1Ct.Get() == CTxDestination(pubkey1C.GetKeyID()));
		BOOST_CHECK(addr2Ct.Get() == CTxDestination(pubkey2C.GetKeyID()));
	} else {
		CTongxingpointsAddress addr1Cm("1NoJrossxPBKfCHuJXT4HadJrXRE9Fxiqs");
		CTongxingpointsAddress addr2Cm("1CRj2HyM1CXWzHAXLQtiGLyggNT9WQqsDs");
