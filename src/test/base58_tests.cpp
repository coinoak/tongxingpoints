...
//            // Note: CTongxingpointsSecret::SetString tests isValid, whereas CTongxingpointsAddress does not!
...
//                continue;
//            }
//            CTongxingpointsAddress addrOut;
...
//    CTongxingpointsAddress dummyAddr;
