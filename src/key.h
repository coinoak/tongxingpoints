...
#ifndef TONGXINGPOINTS_KEY_H
#define TONGXINGPOINTS_KEY_H
...
public:
	...
	unsigned int size() const {
		unsigned int len = GetLen(vch[0]);
		 if(len != 33) //only use 33 for Tongxingpoints sys
			 return 0;
		return len;
	}
 ...
 *  A CTxDestination is the internal data type encoded in a CTongxingpointsAddress
 */
