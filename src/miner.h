...
// Copyright (c) 2009-2013 The Tongxingpoints developers
// Copyright (c) 2016 The Tongxingpoints developers
// Distributed under the MIT/X11 software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef TONGXINGPOINTS_MINER_H
#define TONGXINGPOINTS_MINER_H
...
void GenerateTongxingpointsBlock(bool fGenerate, CWallet* pwallet, int nThreads);
